...
export default function RegisterPage() {
    ...
    return (
        <div className="w-full animate-fade-in">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-foreground mb-2">Join as an Artisan</h1>
                <p className="text-neutral-500">
                    Join Artiseman and start getting high-paying jobs.
                </p>
            </div>
            ...
            <p className="mt-8 text-center text-sm text-neutral-500">
                ...
                <Link href="/artisan/login" className="font-medium text-primary hover:text-primary-dark transition-colors">
                    Sign in
                </Link>
            </p>
        </div>
